(function ($) {
  ...
  // ---------------------------------------------------Upcoming auction section images filter-----------------------------------------------------
  // play
  ...
  // ---------------------------------------------------Upcoming auction section images filter end-----------------------------------------------------
  ...
  $(document).ready(function () {
    ...
    if ($("#bid_counter3").length) {
      // If you need specific date then comment out 1 and comment in 2
      let endDate = "2021/05/20"; //This is 1
      // let endDate = (new Date().getFullYear()) + '/' + (new Date().getMonth() + 1) + '/' + (new Date().getDate() + 1); //This is 2
    ...
    // var temp = $('#bidPrice').html();
    $('.product-details .row button').on('click', (e) => {
      e.preventDefault();
      // var value = $('#takeBid').val();
      // if(temp < value) {
      // $('.product-details .row .price-table .header h3').html(`Rs. ${value}`);
      // } else {
      // $('.product-details .row .price-table .header h3').html(`Rs. ${temp}`);
      // }
      // console.log(value);
    });
